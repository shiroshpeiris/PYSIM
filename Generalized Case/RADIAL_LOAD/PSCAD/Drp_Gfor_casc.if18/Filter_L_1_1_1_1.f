...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_1Dyn(Filter_Calc, Ldamp_in, Cfilter_in, &
...
! 190:[sqrt] Square Root 
      ...
      IF (RT_2 .LT. 0.0) THEN
        RT_1 = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,2136602957,1,2,"A negative value i&
     &s detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,2136602957,1,-1,"Input is treated &
     &as 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
! 240:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,464182575)
...
! 250:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1475040382)
...
! 260:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1928931843)
...
! 270:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1566514480)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_1Out()
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_1Dyn_Begin(Ldamp_in, Cfilter_in,        &
     &   Cdamp_in, Rdamp_in)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_1Out_Begin(Ldamp_in, Cfilter_in,        &
     &   Cdamp_in, Rdamp_in)
