...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1Dyn(Filter_Calc, Ldamp_in, Cfilter_in,   &
...
! 190:[sqrt] Square Root 
      ...
      IF (RT_2 .LT. 0.0) THEN
        RT_1 = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,343164886,1,2,"A negative value is&
     & detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,343164886,1,-1,"Input is treated a&
     &s 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
! 240:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,993804387)
...
! 250:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1979933769)
...
! 260:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1117982011)
...
! 270:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,42221164)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1Dyn_Begin(Ldamp_in, Cfilter_in,          &
     &   Cdamp_in, Rdamp_in)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1Out_Begin(Ldamp_in, Cfilter_in,          &
     &   Cdamp_in, Rdamp_in)
