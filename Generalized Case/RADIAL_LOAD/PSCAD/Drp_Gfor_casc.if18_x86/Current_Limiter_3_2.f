...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2Dyn(Iqout, Idout, Iqin, Idin,       &
     &   Theta)
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'Current_Limiter_3_2.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
! 140:[sqrt] Square Root 
      ...
      IF (RT_3 .LT. 0.0) THEN
        RT_4 = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,1749091723,1,2,"A negative value i&
     &s detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,1749091723,1,-1,"Input is treated &
     &as 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
!  Hard_Limit
      ...
      ELSE
        ...
        IF (STORL(NSTORL) .EQV. .FALSE.) THEN
          CALL EMTDC_WARN(ICALL_NO,217297021,1,"Lower limit is more than&
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2Out()
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2Out_Begin()
