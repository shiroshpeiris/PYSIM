...
!=======================================================================
      ...
      SUBROUTINE PQ_control_10_2_2Dyn(UFqref, W, Wref, Qref, Pref,      &
     &   Qmeas, Pmeas, KpP, KiP, Kq, Vpccref, Controlmode, Vpccmeas,    &
     &   Wmeas, Qcontrol, H, D, VratedLLrms, w0)
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'PQ_control_10_2_2.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
!=======================================================================
      ...
      SUBROUTINE PQ_control_10_2_2Out()
...
!=======================================================================
      ...
      SUBROUTINE PQ_control_10_2_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE PQ_control_10_2_2Out_Begin()
