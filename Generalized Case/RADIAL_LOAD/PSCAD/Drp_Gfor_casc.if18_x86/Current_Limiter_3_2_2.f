...
!-----------------------------------------------------------------------
! Component     : Current_Limiter_3_2_2
! Description   : 
!-----------------------------------------------------------------------
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2_2Dyn(Iqout, Idout, Iqin, Idin,     &
     &   Theta)
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'Current_Limiter_3_2_2.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
! 140:[sqrt] Square Root 
      ...
      IF (RT_3 .LT. 0.0) THEN
        RT_4 = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,994139986,1,2,"A negative value is&
     & detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,994139986,1,-1,"Input is treated a&
     &s 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
!  Hard_Limit
      ...
      ELSE
        ...
        IF (STORL(NSTORL) .EQV. .FALSE.) THEN
          CALL EMTDC_WARN(ICALL_NO,182340885,1,"Lower limit is more than&
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2_2Out()
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE Current_Limiter_3_2_2Out_Begin()
