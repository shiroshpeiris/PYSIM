...
#------------------------------------------------------------------------------
# Project 'Drp_Gfor_casc' make using the 'Intel_ Fortran Compiler Classic 2021.5.0' compiler.
#------------------------------------------------------------------------------
...
FC_Objects = \
 DS.$(FC_Suffix) \
 Main.$(FC_Suffix) \
 Converter_16_2_1.$(FC_Suffix) \
 PI_Section.$(FC_Suffix) \
