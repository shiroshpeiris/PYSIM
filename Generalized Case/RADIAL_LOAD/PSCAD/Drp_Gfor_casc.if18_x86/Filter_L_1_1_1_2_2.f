...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_2_2Dyn(Filter_Calc, Ldamp_in,           &
     &   Cfilter_in, Cdamp_in, Rdamp_in, freq_cutoff, Lvsc)
...
!---------------------------------------
      ...
      IF ( TIMEZERO ) THEN
         FILENAME = 'Filter_L_1_1_1_2_2.dta'
         CALL EMTDC_OPENFILE
         SECTION = 'DATADSD:'
...
! 190:[sqrt] Square Root 
      ...
      IF (RT_2 .LT. 0.0) THEN
        RT_1 = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,1629008888,1,2,"A negative value i&
     &s detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,1629008888,1,-1,"Input is treated &
     &as 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
! 240:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,949374623)
...
! 250:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1927746795)
...
! 260:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,1666277541)
...
! 270:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,460498235)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_2_2Out()
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_2_2Dyn_Begin(Ldamp_in, Cfilter_in,      &
     &   Cdamp_in, Rdamp_in)
...
!=======================================================================
      ...
      SUBROUTINE Filter_L_1_1_1_2_2Out_Begin(Ldamp_in, Cfilter_in,      &
     &   Cdamp_in, Rdamp_in)
