...
!=======================================================================
      ...
      SUBROUTINE PI_Section_2Dyn(Rtx_m, Ltx_m, Ctx_m, Wbase, Zbase,     &
     &   Length)
...
! 510:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,745824478)
...
! 520:[varrlc] Variable R, L or C  
      CALL COMPONENT_ID(ICALL_NO,397704722)
...
! 10:[multimeter] Multimeter 
     ...
     &IBRCH(1)+9),RTCF(IVD1_1+2),0)
      IF (UPDATE_AG) CALL PSCAD_AGR2(ICALL_NO,683534490,RVD1_1,"Pd")
      PPI23 = RVD1_1
      RVD1_1 = RTCF(IVD1_1) * Q3PH3(SS(1), (IBRCH(1)+7), (IBRCH(1)+8), (&
     &IBRCH(1)+9),RTCF(IVD1_1+2),0)
      IF (UPDATE_AG) CALL PSCAD_AGR2(ICALL_NO,683534490,RVD1_1,"Qd")
      RVD1_1 = RTCF(IVD1_1+1) * VM3PH2(SS(1), NT_2(1), NT_2(2), NT_2(3),&
     & RTCF(IVD1_1+2))
      IF (UPDATE_AG) CALL PSCAD_AGR2(ICALL_NO,683534490,RVD1_1,"Vd")
     ...
     &.0,RTCF(IVD1_1+2))
      IF (FIRSTSTEP) THEN
        CALL PSCAD_AGI2(ICALL_NO,683534490,1,"hide1")
        CALL PSCAD_AGI2(ICALL_NO,683534490,1,"hide2")
      ENDIF
...
!=======================================================================
      ...
      SUBROUTINE PI_Section_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE PI_Section_2Out_Begin()
