...
!=======================================================================
      ...
      SUBROUTINE VF_Control_7_2Dyn(Vref, Igrid, Vgrid, I_inv, W,        &
...
! 940:[Current_Limiter_3_2]  
      CALL Current_Limiter_3_2Dyn(RT_1, RT_2, RT_3, RT_4, Theta)
...
! 1160:[sqrt] Square Root 
      ...
      IF (RT_84 .LT. 0.0) THEN
        Iout = 0.0
        IF (.NOT. LVD1_1) THEN
          CALL EMTDC_MESSAGE(ICALL_NO,357344069,1,2,"A negative value is&
     & detected as an input to the Square Root function. ")
          CALL EMTDC_MESSAGE(ICALL_NO,357344069,1,-1,"Input is treated a&
     &s 0.0.")
          STORL(NSTORL) = .TRUE.
        ENDIF
      ELSE
...
!=======================================================================
      ...
      SUBROUTINE VF_Control_7_2Dyn_Begin()
...
!     SUBR    Current_Limiter_3_2Dyn_Begin  ! 
...
! 940:[Current_Limiter_3_2]  
      CALL Current_Limiter_3_2Dyn_Begin()
...
!=======================================================================
      ...
      SUBROUTINE VF_Control_7_2Out_Begin()
...
!     SUBR    Current_Limiter_3_2Out_Begin  ! 
...
! 940:[Current_Limiter_3_2]  
      CALL Current_Limiter_3_2Out_Begin()
