...
! Control Signals
      ...
      REAL     Lconv_G_1, RT_21, L_grid, RT_22
      REAL     R_grid, VrefGS_a_1, VrefGS_b_1
      REAL     VrefGS_c_1, RT_23, freq_1_1
      REAL     Cfreq_Gr_1, RT_24(6), DBlk_Gr_1
...
!---------------------------------------
      ...
      VRMS     = STOF(ISTOF + 36)
      VRMSF    = STOF(ISTOF + 37)
      L_Load   = STOF(ISTOF + 38)
      R_Load   = STOF(ISTOF + 39)
      Vpcc     = STOF(ISTOF + 43)
      Pg       = STOF(ISTOF + 44)
      Ig       = STOF(ISTOF + 45)
      Qg       = STOF(ISTOF + 46)
      ...
      RT_20    = STOF(ISTOF + 50)
      IRMS     = STOF(ISTOF + 54)
      Lconv_G_1 = STOF(ISTOF + 55)
      RT_21    = STOF(ISTOF + 56)
      L_grid   = STOF(ISTOF + 57)
      RT_22    = STOF(ISTOF + 58)
      R_grid   = STOF(ISTOF + 59)
      VrefGS_a_1 = STOF(ISTOF + 60)
      VrefGS_b_1 = STOF(ISTOF + 61)
      VrefGS_c_1 = STOF(ISTOF + 62)
      RT_23    = STOF(ISTOF + 63)
      freq_1_1 = STOF(ISTOF + 64)
      Cfreq_Gr_1 = STOF(ISTOF + 65)
...
! Array (1:3) quantities...
      DO IT_0 = 1,3
         ...
         RT_5(IT_0) = STOF(ISTOF + 18 + IT_0)
         RT_18(IT_0) = STOF(ISTOF + 39 + IT_0)
         Igrid(IT_0) = STOF(ISTOF + 50 + IT_0)
...
! 590:[pgb] Output Channel 'Pdq'

      PGB(IPGB+1) = P

! 600:[varrlc] Variable R, L or C  
...
!---------------------------------------
      ...
      STOF(ISTOF + 36) = VRMS
      STOF(ISTOF + 37) = VRMSF
      STOF(ISTOF + 38) = L_Load
      STOF(ISTOF + 39) = R_Load
      STOF(ISTOF + 43) = Vpcc
      STOF(ISTOF + 44) = Pg
      STOF(ISTOF + 45) = Ig
      STOF(ISTOF + 46) = Qg
      ...
      STOF(ISTOF + 50) = RT_20
      STOF(ISTOF + 54) = IRMS
      STOF(ISTOF + 55) = Lconv_G_1
      STOF(ISTOF + 56) = RT_21
      STOF(ISTOF + 57) = L_grid
      STOF(ISTOF + 58) = RT_22
      STOF(ISTOF + 59) = R_grid
      STOF(ISTOF + 60) = VrefGS_a_1
      STOF(ISTOF + 61) = VrefGS_b_1
      STOF(ISTOF + 62) = VrefGS_c_1
      STOF(ISTOF + 63) = RT_23
      STOF(ISTOF + 64) = freq_1_1
      STOF(ISTOF + 65) = Cfreq_Gr_1
...
! Array (1:3) quantities...
      DO IT_0 = 1,3
         ...
         STOF(ISTOF + 18 + IT_0) = RT_5(IT_0)
         STOF(ISTOF + 39 + IT_0) = RT_18(IT_0)
         STOF(ISTOF + 50 + IT_0) = Igrid(IT_0)
...
! Control Signals
      ...
      REAL     Lconv_G_1, RT_21, RT_22, freq_1_1
...
! Control Signals
      ...
      REAL     RT_22, freq_1_1, Cfreq_Gr_1
      REAL     DBlk_Gr_1
