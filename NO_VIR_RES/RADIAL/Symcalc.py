...
dI1_C = [dI1.coeff(I1),dI1.coeff(I2),dI1.coeff(I3),dI1.coeff(I4),dI1.coeff(I5),dI1.coeff(Vg),dI1.coeff(Vc1),dI1.coeff(Vc2),dI1.coeff(Vc3),dI1.coeff(Vc4),dI1.coeff(Vc5)]
dI2_C = [dI2.coeff(I1),dI2.coeff(I2),dI2.coeff(I3),dI2.coeff(I4),dI2.coeff(I5),dI2.coeff(Vg),dI2.coeff(Vc1),dI2.coeff(Vc2),dI2.coeff(Vc3),dI2.coeff(Vc4),dI2.coeff(Vc5)]
dI3_C = [dI3.coeff(I1),dI3.coeff(I2),dI3.coeff(I3),dI3.coeff(I4),dI3.coeff(I5),dI3.coeff(Vg),dI3.coeff(Vc1),dI3.coeff(Vc2),dI3.coeff(Vc3),dI3.coeff(Vc4),dI3.coeff(Vc5)]
dI4_C = [dI4.coeff(I1),dI4.coeff(I2),dI4.coeff(I3),dI4.coeff(I4),dI4.coeff(I5),dI4.coeff(Vg),dI4.coeff(Vc1),dI4.coeff(Vc2),dI4.coeff(Vc3),dI4.coeff(Vc4),dI4.coeff(Vc5)]
dI5_C = [dI5.coeff(I1),dI5.coeff(I2),dI5.coeff(I3),dI5.coeff(I4),dI5.coeff(I5),dI5.coeff(Vg),dI5.coeff(Vc1),dI5.coeff(Vc2),dI5.coeff(Vc3),dI5.coeff(Vc4),dI5.coeff(Vc5)]
...
LV_gridparams = np.concatenate((dI1_C, dI2_C, dI3_C, dI4_C, dI5_C))

LV_gridparams = np.array(LV_gridparams, dtype=np.float32)

# print(LV_gridparams[0:5])
# print(LV_gridparams[11:16])
# print(LV_gridparams[22:27])
# print(LV_gridparams[33:38])
# print(LV_gridparams[44:49])
#
# print(LV_gridparams[4:11])
# print(LV_gridparams[15:22])
# print(LV_gridparams[26:33])
# print(LV_gridparams[37:44])
# print(LV_gridparams[48:55])
